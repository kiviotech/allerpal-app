...
const messages = [
  { id: '1', type: 'received', text: 'Welcome to Lorem ipsum, how can we help you?', time: '10:15 AM' },
  { id: '2', type: 'sent', text: 'Lorem ipsum', time: '10:16 AM' },
  { id: '3', type: 'sent', text: 'A supportive space where practitioners and enthusiasts.', time: '10:17 AM' },
  { id: '4', type: 'received', text: 'Please rate chat support experience', time: '10:18 AM', ratingRequest: true },
];
...
const ChatScreen = () => {
  ...
  return (
    <View style={styles.container}>
     ...
     <TouchableOpacity style={styles.backArrow} onPress={() => router.push('./Chat') }>
