...
const ReviewsSection = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* No Reviews Message */}
      <Text style={styles.noReviewsText}>No review yet, be the first one to review</Text>
    </View>
  );
};
