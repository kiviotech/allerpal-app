...
const RestaurantBasedOnFood = () => {
  const [restaurants, setRestaurants] = useState([]);
  const { restaurants: restaurantsParam } = useSearchParams();

  console.log('sdfgh',restaurants)

  useEffect(() => {
    if (restaurantsParam) {
      setRestaurants(JSON.parse(restaurantsParam)); // Parse the received string
    }
  }, [restaurantsParam]);
...
export default RestaurantBasedOnFood;