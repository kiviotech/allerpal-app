...
import { fetchReviews } from '../../src/services/reviewServices';
...
const ReviewCards = () => {
    ...
    useEffect(() => {
        const loadReviews = async () => {
            ...
            console.log(fetchedReviews.data[0].Image[0].url)
       ...
       return(
        ...
        {reviews.map((item, index) => (
                <View key={index} style={styles.card}>
                    <View style={styles.header}>
                        <View style={styles.profileContainer}>
                            <Image source={{ uri: 'https://img.freepik.com/free-vector/man-profile-account-picture_24908-81754.jpg' }} style={styles.profileImage} />
                            <View style={styles.ratingBadge}>
