...
export const getUserAllAllergies = () =>
  apiClient.get(userAllergyEndpoints.getUserAllergies);

export const getUserAllergyById = (id) =>
  apiClient.get(userAllergyEndpoints.getUserAllergyById(id));
...
export const getUserAllergiesByUser = (userId) =>
  apiClient.get(userAllergyEndpoints.getUserAllergiesByUser(userId));
