...
const FinishSetUp = () => {
  ...
  const isAnyAllergenSelected = Object.values(allergens).some(
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.title}>
        Select your allergens to create and save your personalized allergy
      ...
      <TouchableOpacity
        style={[
          styles.button,
          !(termsAccepted && isAnyAllergenSelected) && styles.buttonDisabled,
        ]}
